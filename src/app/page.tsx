...
const MOCK_EVENTS: EventItem[] = [
  { id: '1', project_id: 'p1', project_name: '대우ST', start_date: '2026-10-14', start_time: '10:00', instructor_name: '이은선', location: '영통푸르지오' },
  { id: '2', project_id: 'p2', project_name: '홈앤코칭', start_date: '2026-10-14', start_time: '10:00', participant_name: '김진수', coach_name: '신호진', round_label: '1차', status: '확정' },
  { id: '3', project_id: 'p3', project_name: '팀빌딩', start_date: '2026-10-12', end_date: '2026-10-14', round_label: '6기' },
  { id: '4', project_id: 'p4', project_name: '리더십', start_date: '2026-10-21', end_date: '2026-10-23', round_label: '2차' },
];
    ...
    <main className="pb-24 pt-4 px-4 max-w-md mx-auto min-h-screen bg-white">
      ...
      <div className="grid grid-cols-3 gap-2 mb-6">
        <button
          ...
          className="bg-slate-50 border border-slate-100 p-3 rounded-2xl text-left shadow-sm active:scale-95 transition-transform"
        >
        ...
        >
          ...
          <span className="text-lg font-bold text-slate-800">12<span className="text-xs font-normal">건</span></span>
        </button>
